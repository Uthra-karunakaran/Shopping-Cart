  ...
  const handleDecrement = () => {
    ...
    return(
        ...
        <div className="relative flex items-center">
          ...
          <input type="text" id="counter-input"  value={localCounter} data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" />
